export default [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "bytes32", name: "srcPool", type: "bytes32" },
          { internalType: "address", name: "dstPool", type: "address" },
          {
            internalType: "address",
            name: "dstExternalAccount",
            type: "address",
          },
          { internalType: "address", name: "dstTrader", type: "address" },
          ...
          { internalType: "bytes32", name: "srcCaller", type: "bytes32" },
          { internalType: "address", name: "dstContract", type: "address" },
          { internalType: "bytes", name: "dstContractCalldata", type: "bytes" },
        ],
    ...
    inputs: [
      {
        components: [
          { internalType: "address", name: "pool", type: "address" },
          { internalType: "address", name: "externalAccount", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes", name: "guardianSignature", type: "bytes" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "amountToApprove", type: "uint256" },
    ],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "address", name: "externalAccount", type: "address" },
          { internalType: "address", name: "trader", type: "address" },
          { internalType: "address", name: "effectiveTrader", type: "address" },
          { internalType: "address", name: "baseToken", type: "address" },
          { internalType: "address", name: "quoteToken", type: "address" },
          {
            internalType: "uint256",
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "address", name: "srcPool", type: "address" },
          { internalType: "bytes32", name: "dstPool", type: "bytes32" },
          {
            internalType: "address",
          ...
          { internalType: "address", name: "trader", type: "address" },
          { internalType: "bytes32", name: "dstTrader", type: "bytes32" },
          { internalType: "address", name: "baseToken", type: "address" },
          { internalType: "bytes32", name: "quoteToken", type: "bytes32" },
          { internalType: "uint256", name: "baseTokenAmount", type: "uint256" },
          {
            internalType: "uint256",
            name: "quoteTokenAmount",
          ...
          { internalType: "uint256", name: "quoteExpiry", type: "uint256" },
          { internalType: "bytes32", name: "txid", type: "bytes32" },
          { internalType: "address", name: "xChainMessenger", type: "address" },
          { internalType: "bytes", name: "takerSignature", type: "bytes" },
          { internalType: "bytes", name: "makerSignature", type: "bytes" },
        ],
      ...
      { internalType: "bytes32", name: "dstContract", type: "bytes32" },
      { internalType: "bytes", name: "dstCalldata", type: "bytes" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint16", name: "otherHashflowChainId", type: "uint16" },
      { internalType: "bytes32", name: "caller", type: "bytes32" },
      { internalType: "bool", name: "authorized", type: "bool" },
    ],
    name: "updateXChainCallerAuthorization",
    outputs: [],
  ...
  },
  {
    inputs: [
      { internalType: "uint16", name: "otherHashflowChainId", type: "uint16" },
      { internalType: "bytes32", name: "otherPool", type: "bytes32" },
      { internalType: "bool", name: "authorized", type: "bool" },
    ],
    name: "updateXChainPoolAuthorization",
    outputs: [],
