export default [
  ...
  {
    inputs: [{ internalType: "uint256", name: "bridgeFee", type: "uint256" }],
  ...
  { inputs: [], name: "PriceFeedNotAvailable", type: "error" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "contract IERC20", name: "_xezETH", type: "address" },
      {
      ...
      { internalType: "contract IConnext", name: "_connext", type: "address" },
  ...
  },
  {
    ...
    name: "oracle",
    outputs: [
      { internalType: "contract IRenzoOracleL2", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_newBatchSize", type: "uint256" },
    ],
