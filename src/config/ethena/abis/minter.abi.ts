export default [
  {
    inputs: [
      { internalType: "contract IUSDe", name: "_usde", type: "address" },
  ...
  { inputs: [], name: "InvalidUSDeAddress", type: "error" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "USDe", type: "address" },
    ],
    name: "USDeSet",
    type: "event",
  },
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "usde_amount", type: "uint256" },
        ],
  ...
  },
  {
    inputs: [],
    name: "usde",
    outputs: [{ internalType: "contract IUSDe", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
