export default [
  ...
  {
    inputs: [],
    name: "NotClaimableProfit",
    type: "error",
  },
  {
    inputs: [],
    name: "OldAccountDoesNotExist",
    type: "error",
  },
  {
    inputs: [
  ...
  },
  {
    ...
    name: "_simulateCollateralLiquidation",
    outputs: [
      {
        components: [
          {
        ...
        internalType: "struct AccountLib.CollateralLiquidation",
        name: "",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    name: "createNewAccountDepositCollateralAndBorrow",
    outputs: [
      {
        internalType: "address payable",
        name: "account",
  ...
  },
  {
    ...
    name: "simulateCollateralLiquidation",
    outputs: [
      {
        components: [
          {
