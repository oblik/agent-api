export default [
  {
    inputs: [
      ...
      {
        components: [
          { internalType: "uint64", name: "marginRatioMax", type: "uint64" },
          {
            internalType: "uint64",
            name: "liquidationSpreadMax",
            type: "uint64",
          },
          { internalType: "uint64", name: "earningsRateMax", type: "uint64" },
          { internalType: "uint64", name: "marginPremiumMax", type: "uint64" },
          { internalType: "uint64", name: "spreadPremiumMax", type: "uint64" },
          {
  ...
  },
  {
    constant: true,
    inputs: [
      { internalType: "uint256", name: "heldMarketId", type: "uint256" },
      { internalType: "uint256", name: "owedMarketId", type: "uint256" },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "bool", name: "isClosing", type: "bool" },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "contract IInterestSetter", name: "", type: "address" },
    ],
    payable: false,
    stateMutability: "view",
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      ...
      { internalType: "address", name: "salvager", type: "address" },
    ],
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: "address", name: "autoTrader", type: "address" },
      { internalType: "bool", name: "special", type: "bool" },
    ],
