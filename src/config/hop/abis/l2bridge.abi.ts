export default [
  {
    inputs: [
      { internalType: "contract IL2_Bridge", name: "_bridge", type: "address" },
      {
        internalType: "contract IERC20",
        name: "_l2CanonicalToken",
        type: "address",
      },
      { internalType: "bool", name: "_l2CanonicalTokenIsEth", type: "bool" },
      { internalType: "contract IERC20", name: "_hToken", type: "address" },
      {
  ...
  },
  {
    ...
    name: "bridge",
    outputs: [
      { internalType: "contract IL2_Bridge", name: "", type: "address" },
    ],
