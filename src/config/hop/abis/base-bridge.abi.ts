export default [
  {
    inputs: [
      ...
      { internalType: "address", name: "l1Governance", type: "address" },
      {
        internalType: "contract HopBridgeToken",
        name: "hToken",
        type: "address",
      },
      { internalType: "address", name: "l1BridgeAddress", type: "address" },
      { internalType: "uint256[]", name: "activeChainIds", type: "uint256[]" },
      { internalType: "address[]", name: "bonders", type: "address[]" },
      { internalType: "uint32", name: "_defaultGasLimit", type: "uint32" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "bonder", type: "address" }],
    name: "addBonder",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    ...
    name: "ammWrapper",
    outputs: [
      { internalType: "contract I_L2_AmmWrapper", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "transferNonce", type: "bytes32" },
  ...
  {
    inputs: [{ internalType: "address", name: "maybeBonder", type: "address" }],
    name: "getIsBonder",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
    stateMutability: "view",
    type: "function",
  ...
  },
  {
    ...
    name: "hToken",
    outputs: [
      { internalType: "contract HopBridgeToken", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      {
        internalType: "contract I_L2_AmmWrapper",
        name: "_ammWrapper",
        type: "address",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_l1BridgeAddress", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_l1BridgeCaller", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_l1Governance", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_minBonderBps", type: "uint256" },
      {
        internalType: "uint256",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "transferIdTreeIndex", type: "uint256" },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "bonder", type: "address" },
      { internalType: "bytes32[]", name: "transferIds", type: "bytes32[]" },
      { internalType: "uint256", name: "totalAmount", type: "uint256" },
    ],
